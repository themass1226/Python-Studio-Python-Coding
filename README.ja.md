...
- **コードスニペット（Monaco エディター）**：Monaco エディターを内蔵し、コードスニペットを素早く編集・実行、グラフィック出力にも対応；
- **Jupyter ノートブック対応**：JupyterLite カーネルを内蔵し、`.ipynb` ノートブックの開閉・編集・実行をオフラインで実行可能。
...
| コードエディター | Monaco Editor（Web 埋め込み） |
| Python カーネル | JupyterLite（WASM、ローカル実行・オフライン対応） |
| ローカルサーバー | ネイティブ BSD Socket 静的サーバー（Node エンジン代替） |
| ファイル同期 | ローカルファイルシステム ⇔ Jupyter 仮想ファイルシステムの双方向同期 |
| マルチウィンドウ | カスタムフローティングウィンドウ管理（WindowControllerAdder） |
| クロススクリーン | ローカルネットワーク Web サービス + ブラウザアクセス |
...
<p align="center">
  <img src="assets/ja/iphone-1.png" width="22%" alt="iPhone スクリーンショット 1" />
  <img src="assets/ja/iphone-2.png" width="22%" alt="iPhone スクリーンショット 2" />
  <img src="assets/ja/iphone-3.png" width="22%" alt="iPhone スクリーンショット 3" />
  <img src="assets/ja/iphone-4.png" width="22%" alt="iPhone スクリーンショット 4" />
</p>

### iPad

<p align="center">
  <img src="assets/ja/ipad-1.png" width="45%" alt="iPad スクリーンショット 1" />
  <img src="assets/ja/ipad-2.png" width="45%" alt="iPad スクリーンショット 2" />
</p>
<p align="center">
  <img src="assets/ja/ipad-3.png" width="45%" alt="iPad スクリーンショット 3" />
  <img src="assets/ja/ipad-4.png" width="45%" alt="iPad スクリーンショット 4" />
</p>
...
2. 初回起動時にローカル Jupyter カーネルを自動展開・初期化；
