...
- **代码速写（Monaco 编辑器）**：内置 Monaco 代码编辑器，快速编辑代码片段，支持图形输出，即写即跑；
- **Jupyter 笔记本支持**：内置 JupyterLite 内核，支持打开、编辑、运行 `.ipynb` 笔记本，无需联网即可运行 Python。

## 技术架构

| 模块 | 技术 |
| --- | --- |
| 前端界面 | UIKit / Swift / Objective-C |
| 代码编辑器 | Monaco Editor（Web 内嵌） |
| Python 内核 | JupyterLite（WASM，本地运行，无需联网） |
| 本地服务 | 原生 BSD Socket 静态服务器（替代 Node 引擎） |
| 文件同步 | 本地文件系统 ↔ Jupyter 虚拟文件系统双向同步 |
| 多窗口 | 自定义浮动窗口管理（WindowControllerAdder） |
| 跨屏协作 | 局域网 Web 服务 + 浏览器访问 |
...
<p align="center">
  <img src="assets/zh-Hans/iphone-1.png" width="22%" alt="iPhone 截图 1" />
  <img src="assets/zh-Hans/iphone-2.png" width="22%" alt="iPhone 截图 2" />
  <img src="assets/zh-Hans/iphone-3.png" width="22%" alt="iPhone 截图 3" />
  <img src="assets/zh-Hans/iphone-4.png" width="22%" alt="iPhone 截图 4" />
</p>

### iPad

<p align="center">
  <img src="assets/zh-Hans/ipad-1.png" width="45%" alt="iPad 截图 1" />
  <img src="assets/zh-Hans/ipad-2.png" width="45%" alt="iPad 截图 2" />
</p>
<p align="center">
  <img src="assets/zh-Hans/ipad-3.png" width="45%" alt="iPad 截图 3" />
  <img src="assets/zh-Hans/ipad-4.png" width="45%" alt="iPad 截图 4" />
</p>
...
2. 首次启动后，App 会自动解压并初始化本地 Jupyter 内核；
