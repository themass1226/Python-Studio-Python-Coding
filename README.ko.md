...
- **코드 스니펫(Monaco 에디터)**：Monaco 에디터를 내장해 코드 스니펫을 빠르게 편집·실행하고 그래픽 출력도 지원합니다；
- **Jupyter 노트북 지원**：JupyterLite 커널을 내장해 `.ipynb` 노트북을 오프라인으로 열고 편집·실행할 수 있습니다.
...
| 코드 에디터 | Monaco Editor(웹 임베드) |
| Python 커널 | JupyterLite(WASM, 로컬 실행·오프라인 지원) |
| 로컬 서버 | 네이티브 BSD Socket 정적 서버(Node 엔진 대체) |
| 파일 동기화 | 로컬 파일시스템 ⇔ Jupyter 가상 파일시스템 양방향 동기화 |
| 멀티 윈도우 | 커스텀 플로팅 윈도우 관리(WindowControllerAdder) |
| 크로스 스크린 | LAN 웹 서비스 + 브라우저 접근 |
...
<p align="center">
  <img src="assets/ko/iphone-1.png" width="22%" alt="iPhone 스크린샷 1" />
  <img src="assets/ko/iphone-2.png" width="22%" alt="iPhone 스크린샷 2" />
  <img src="assets/ko/iphone-3.png" width="22%" alt="iPhone 스크린샷 3" />
  <img src="assets/ko/iphone-4.png" width="22%" alt="iPhone 스크린샷 4" />
</p>

### iPad

<p align="center">
  <img src="assets/ko/ipad-1.png" width="45%" alt="iPad 스크린샷 1" />
  <img src="assets/ko/ipad-2.png" width="45%" alt="iPad 스크린샷 2" />
</p>
<p align="center">
  <img src="assets/ko/ipad-3.png" width="45%" alt="iPad 스크린샷 3" />
  <img src="assets/ko/ipad-4.png" width="45%" alt="iPad 스크린샷 4" />
</p>
...
2. 첫 실행 시 로컬 Jupyter 커널을 자동으로 압축 해제·초기화합니다；
